...
import { Shield, AlertTriangle, RefreshCw, ChevronLeft, ChevronRight, Inbox, BarChart3, Trash2 } from 'lucide-react';
import { api, ApiError } from '@/lib/api';
import { usePendingCount } from '@/hooks/usePendingCount';

const PAGE_SIZE = 10;
const CLEAR_CONFIRM_TEXT = 'clear all cases';
...
function DashboardContent() {
  ...
  const confirmClearCases = useCallback(async () => {
    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-slate-100 dark:from-slate-950 dark:to-slate-900">
        ...
        <div className="container mx-auto px-3 sm:px-4 py-3 sm:py-4">
          ...
          <div className="hidden sm:flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl font-bold">PhishTrack</h1>
            ...
            <div className="flex items-center gap-2">
              {cases.length > 0 && (
                <Button variant="outline" size="sm" onClick={clearCases} className="gap-2">
          ...
          <div className="sm:hidden">
            ...
            <div className="flex items-center justify-between mb-2">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <h1 className="text-lg font-bold">PhishTrack</h1>
            ...
            <div className="flex items-center gap-1 overflow-x-auto pb-1 -mx-3 px-3 scrollbar-hide">
              {cases.length > 0 && (
                <Button variant="outline" size="sm" onClick={clearCases} className="shrink-0 text-xs gap-1">
      ...
      <footer className="border-t bg-white/50 dark:bg-slate-950/50 backdrop-blur-sm mt-16">
        <div className="container mx-auto px-4 py-6 text-center text-sm text-muted-foreground">
          <p>
            PhishTrack Automated Takedown System • For authorized security researchers only
          </p>
      ...
      {/* Clear All Cases Confirmation Dialog */}
      <Dialog open={isClearDialogOpen} onOpenChange={setIsClearDialogOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              This action cannot be undone. This will permanently delete all cases from the system.
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-4">
            <p className="text-sm text-muted-foreground">
              To confirm, type <kbd className="px-2 py-1 bg-muted rounded text-foreground font-mono">{CLEAR_CONFIRM_TEXT}</kbd> below:
            </p>
            <Input
              value={confirmText}
