...
import { User, LogOut, Shield, Settings, ChevronDown, BarChart3, Inbox, Upload, Radar } from 'lucide-react';
      ...
      {isOpen && (
        <div className="absolute right-0 mt-2 w-56 bg-white dark:bg-slate-900 rounded-lg shadow-lg border z-50">
          ...
          <div className="py-1">
            ...
            {(canViewStats || canImportStats || canViewSubmissions || canViewHunting || isAdmin || canViewUsers || canViewConfig) && (
              <div className="border-t my-1" />
            )}
